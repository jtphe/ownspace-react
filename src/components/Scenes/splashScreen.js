...
import { ImageBackground, Text, StyleSheet, Animated, Image } from 'react-native';
...
class SplashScreen extends React.Component {
    ...
    render() {
        return (
            <ImageBackground source={require('@images/background_ownspace.png')} style={styles.container}>
                <Animated.View style={[{
...
const styles = StyleSheet.create({
    ...
    containerSlogan: { flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 24 },
